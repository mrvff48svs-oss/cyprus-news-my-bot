...
# Если пост не опубликовался за 6 часов — считается устаревшим и удаляется
...
async def cleanup_old_queued() -> int:
    ...
    Если пост висит в queued или awaiting_review дольше POST_MAX_AGE_HOURS —
    он удаляется, чтобы канал не публиковал старые новости.
    """
