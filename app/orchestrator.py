...
def setup_scheduler() -> AsyncIOScheduler:
    ...
    # Сбор — раз в 30 минут (источники не успевают обновиться чаще)
    sched.add_job(
        collect_job,
    ...
    # Обработка — раз в 15 минут (между сборами успевает разгребать)
    sched.add_job(
        process_job,
    ...
    # Публикация — раз в 2 часа (но rate limit в publisher тоже стоит 2 часа)
    sched.add_job(
        publish_job,
